...
public final class AssetsConstants {
    ...
    public static final String MAP3 = "zones/map3.bmp";
    public static final String MAP4 = "zones/map4.bmp";
    public static final String MAP5 = "zones/map5.bmp";
    ...
    public static final String INVENTORY_WEAPON_TAB = "inv/weaponTab.png";
    public static final String INVENTORY_USABLE_TAB = "inv/usableTab.png";
    public static final String INVENTORY_SELECTED_ITEM = "inv/selectedItem.png";
    public static final String INVENTORY_SELECTED_TAB = "inv/selectedTab.png";
    public static final String INVENTORY_QUEST_TAB = "inv/questTab.png";
    public static final String INVENTORY_MISC_TAB = "inv/miscTab.png";
    ...
    public static final String QUICK_INFO = "quickinfo/quickInfo.png";
    public static final String HEALTH_BAR = "quickinfo/healthBar.png";
    public static final String STAMINA_BAR = "quickinfo/staminaBar.png";
    public static final String MANA_BAR = "quickinfo/manaBar.png";
    public static final String BOTTOM_BAR = "quickinfo/bottomBar.png";
    public static final String PLAYER_SHEET = "characters/player.png";
    public static final String FOE_SHEET = "characters/foe.png";
